...
I recommend cloning both the SPF-Tools and the Postwhite repos into your ```/usr/local/bin/``` directory. Once you're satisfied with its performance, set a daily [cron](crontab) job to pick up any new hosts in the mailers' SPF records like this:
